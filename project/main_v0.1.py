...
options = [ Option("MoistureLevel", 10, "Set soil", "moisture", False, "", "", 1, 100, 1), Option("Threshold", 9, "Set watering", "threshold", True, "", "", 0, 100, 1), Option("PumpRunTime", 5, "Set pump run", "time", True, "", "", 0.0, 6, 0.1), Option("PumpControl", 0, "Start/stop pump", "", False, "Pump on", "Pump off", 0, 0, 0) ]
...
def get_moisture():
    # value adc_air 53k = dry
    # value adc_water 24k = wet
...
def get_moisture_2min_avg(moisture_values):
    if len(moisture_values) < 2: # if there is less measurements than 24, return zero
        return 0
    else:
...
if __name__ == "__main__":
    ...
    pump_run_time = 5 # how long the pump will run
